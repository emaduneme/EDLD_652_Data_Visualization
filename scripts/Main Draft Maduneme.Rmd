...
knitr::opts_chunk$set(echo = TRUE,
                      ...
                      message = FALSE)
library(pacman)
p_load(tidyverse, esquisse, dlookr, rio, here, readr, tidytext, knitr, janitor, expss, hrbrthemes, dplyr, flextable, labelled, sjlabelled,  gghighlight, colorblindr, forcats, treemap)
