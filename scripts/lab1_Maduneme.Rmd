...
library(pacman)
p_load(tidyverse, tidytext, here, rio)
```
...
I also used a density plot with smooth bandwidth as it adheres to the assigment instructions while providing a clear distribution of the variable which appears to be skewed. 
